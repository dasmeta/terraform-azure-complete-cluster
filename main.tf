...
resource "azurerm_resource_group" "ask_rg" {
  name     = var.resource_group_name
  location = var.location
}

# resource "azurerm_role_assignment" "roll_acrpull" {
...
#   name                = var.acr_name
#   resource_group_name = azurerm_resource_group.ask_rg.name
#   location            = var.location
#   sku                 = "Basic"
#   admin_enabled       = false
# }
...
resource "azurerm_virtual_network" "network" {
  ...
  resource_group_name = azurerm_resource_group.ask_rg.name
  location            = azurerm_resource_group.ask_rg.location
